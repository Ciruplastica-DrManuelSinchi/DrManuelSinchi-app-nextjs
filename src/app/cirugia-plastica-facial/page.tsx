...
const procedures: Procedure[] = [
    ...
    },
    {
        ...
        slug: 'lifting-facial',
        name: 'Lifting Facial',
        shortDescription: 'Rejuvenecimiento integral del rostro corrigiendo flacidez y arrugas.',
        duration: '3-4 horas',
        recovery: '14-21 días',
        category: ['rostro'],
    ...
    },
    {
        ...
        slug: 'bichectomia',
        name: 'Bichectomia',
        shortDescription: 'Reducción de mejillas para definir pómulos y afinar el rostro.',
        duration: '45 min',
        recovery: '3-5 días',
        category: ['contorno'],
    ...
    },
    {
        ...
        slug: 'otoplastia',
        name: 'Otoplastia',
        shortDescription: 'Corrección de orejas prominentes o asimétricas.',
        duration: '1-2 horas',
        recovery: '7 días',
        category: ['rostro'],
